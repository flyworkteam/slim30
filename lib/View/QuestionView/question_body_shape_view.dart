...
enum _BodyShape { slim, overweight, curvy, muscular }

class QuestionBodyShapeView extends StatefulWidget {
  const QuestionBodyShapeView({super.key});

  @override
  State<QuestionBodyShapeView> createState() => _QuestionBodyShapeViewState();
}

class _QuestionBodyShapeViewState extends State<QuestionBodyShapeView> {
  _BodyShape? _selected;
...
class _BodyShapeItem {
  const _BodyShapeItem(this.shape, this.icon, this.label);
  final _BodyShape shape;
  final String icon;
  final String label;
}
