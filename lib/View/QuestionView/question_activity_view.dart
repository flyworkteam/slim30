...
enum _ActivityLevel { sedentary, light, moderate, intense }

class QuestionActivityView extends StatefulWidget {
  const QuestionActivityView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      _ActivityItem(
        ...
        'iconsax-timer-pause.svg',
        l10n.questionActivitySedentary,
      ),
      _ActivityItem(
        _ActivityLevel.light,
        'iconstack.io - (Basketball).svg',
        l10n.questionActivityLight,
      ),
      _ActivityItem(
        _ActivityLevel.moderate,
        'arcticons_androidrun.svg',
        l10n.questionActivityModerate,
      ),
      _ActivityItem(
        _ActivityLevel.intense,
        'healthicons_exercise-bicycle-outline.svg',
        l10n.questionActivityIntense,
      ),
    ];
                        ...
                        children: [
                          for (int col = 0; col < 2; col++) ...[
                            _ActivityCard(
                              ...
                              selected: _selected == items[row * 2 + col].level,
                              onTap: () => setState(
                                () => _selected = items[row * 2 + col].level,
                              ),
                            ),
...
class _ActivityItem {
  const _ActivityItem(this.level, this.icon, this.label);
