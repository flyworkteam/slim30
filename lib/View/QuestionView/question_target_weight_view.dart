...
class QuestionTargetWeightView extends StatefulWidget {
  const QuestionTargetWeightView({super.key});

  @override
  State<QuestionTargetWeightView> createState() =>
      _QuestionTargetWeightViewState();
}
                ...
                child: Column(
                  children: [
                    SizedBox(
                      width: 342.w,
                      child: Text(
                        l10n.questionTargetWeightTitle,
