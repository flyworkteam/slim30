...
const Map<String, String> _videoUrlByNormalizedName = {
  ...
  'glute bridge march': 'https://slim30.b-cdn.net/workouts/v1/Glute_Bridge_March.mp4',
  ...
  'standing calf raise': 'https://slim30.b-cdn.net/workouts/v1/Standing_Calf_Raise.mp4',
  ...
  'bodyweight squat': 'https://slim30.b-cdn.net/workouts/v1/Bodyweight_Squat.mp4',
  'mountain climber': 'https://slim30.b-cdn.net/workouts/v1/Mountain_Climber.mp4',
  ...
  'fast feet shuffle': 'https://slim30.b-cdn.net/workouts/v1/Fast_Feet_Shuffle.mp4',
  ...
  'jump rope': 'https://slim30.b-cdn.net/workouts/v1/Jump_Rope__ipsiz_simu_lasyon_dahil_.mp4',
  'plank shoulder tap': 'https://slim30.b-cdn.net/workouts/v1/Plank_Shoulder_Tap.mp4',
  'marching plank': 'https://slim30.b-cdn.net/workouts/v1/marching_plank.mp4',
  'standing knee drive': 'https://slim30.b-cdn.net/workouts/v1/Standing_Knee_Drive.mp4',
...
String? resolveExerciseVideoUrl(String title) {
  return resolveExerciseVideoUrlByMedia(
    mediaPath: '',
    title: title,
  );
}
...
String? resolveExerciseVideoUrlByMedia({
  ...
  final mediaBase = _normalizeExerciseName(_basenameWithoutExtension(mediaPath));
  if (mediaBase.isNotEmpty) {
    final mediaCanonical = _canonicalAliasByNormalizedName[mediaBase] ?? mediaBase;
  ...
  final titleCanonical = _canonicalAliasByNormalizedName[titleBase] ?? titleBase;
